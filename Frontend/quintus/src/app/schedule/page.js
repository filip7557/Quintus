...
export default function SchedulePage() {
  ...
  const openEdit = (appointment) => {
    ...
    const canDelete = editable || isAdmin(currentUser);
    setForm({ id: appointment.id, title: appointment.title, date: start ? dateKey(start) : selectedDate, startTime: start ? start.toTimeString().slice(0, 5) : "08:00", endTime: end ? end.toTimeString().slice(0, 5) : "", notes: appointment.notes || "", canDelete, readOnly: !editable, createdByName: appointment.createdByName });
  };
